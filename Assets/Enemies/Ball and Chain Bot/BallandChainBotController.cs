...
public class BallandChainBotController : MonoBehaviour
{
    ...
    const string IDLE = "sci ball and chain_idle";
    const string RUN = "sci ball and chain_run";
    const string ATTACK = "sci ball and chain_charge";
    const string HURT = "sci ball and chain_idle";
    const string DEATH = "sci ball and chain_death";
