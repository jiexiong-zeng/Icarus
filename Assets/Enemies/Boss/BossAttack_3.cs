...
public class BossAttack_3 : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (Vector2.Distance(playerPos.position, animator.GetComponent<Rigidbody2D>().position) <= move.attackRange + 0.3f)
        {
