...
public class SandMonsterController : MonoBehaviour
{
    ...
    const string IDLE = "small monster_idle";
    const string RUN = "small monster_run";
    const string ATTACK = "small monster_attack";
    const string HURT = "small monster_damaged";
    const string DEATH = "small monster_death";
    ...
    void Behavior()
    {
        if (aggroed)
        {
            ...
            else if (Vector2.Distance(playerPos.position, rigidBody.position) <= attackRange)
            {
