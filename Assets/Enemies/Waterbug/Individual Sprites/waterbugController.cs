...
public class waterbugController : MonoBehaviour
{
    ...
    const string IDLE = "waterbug_idle";
    const string RUN = "waterbug_swim";
    const string ATTACK = "waterbug_attack";
    const string HURT = "waterbug_hurt";
    const string DEATH = "waterbug_death";
    ...
    void Behavior()
    {
        if (aggroed)
        {
            ...
            else
            {
                ...
                controller.Fly(moveSpeed * Time.deltaTime, playerPos.position);
            }
        }
        ...
        else
        {
            if (patrol)
            {
                ...
                else
                {
                    ...
                    {
                        ChangeAnimationState(RUN);
                        controller.Fly(moveSpeed * Time.deltaTime, patrolPoint2);
                    }
                    else
                    {
                        ChangeAnimationState(RUN);
                        controller.Fly(moveSpeed * Time.deltaTime, patrolPoint1);
                    }
                }
